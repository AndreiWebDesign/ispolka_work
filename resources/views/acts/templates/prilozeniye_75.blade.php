@extends('layouts.app')
@section('title', 'Акт приёмки молниезащиты')
    ...
    <div class="container py-4 d-flex justify-content-center">
        <form method="POST" action="{{ route('acts.store', $passport) }}" class="bg-white p-4 rounded shadow w-100" style="max-width:900px;">
            ...
            <h2 class="mb-4 text-center">
                Акт № {{ old('number_act', $nextActNumber ?? '') }} приёмки молниезащиты
            </h2>
            ...
            <div class="mb-3">
                ...
                <textarea name="docs" class="form-control" rows="3" placeholder="Исполнительный чертеж, акты на скрытые работы, протокол замеров сопротивления растеканию и др.">{{ old('docs') }}</textarea>
            </div>
