...
<?php $__env->startSection('content'); ?>
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('projects.create')); ?>" class="btn btn-success">Создать паспорт объекта</a>
        </div>
            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $passports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $passport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('projects.show', $passport)); ?>" class="btn btn-primary btn-sm">Открыть</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/ispolka/resources/views/projects/index.blade.php ENDPATH**/ ?>
