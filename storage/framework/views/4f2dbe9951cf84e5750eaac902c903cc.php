<?php $__env->startSection('title', 'Создать акт скрытых работ'); ?>

<?php $__env->startSection('content'); ?>
    <div class="container py-4 d-flex justify-content-center">
        <form method="POST" action="<?php echo e(route('acts.store', $passport)); ?>" class="bg-white p-4 rounded shadow w-100" style="max-width: 900px;">
            <?php echo csrf_field(); ?>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="act_number" class="form-control"
                           value="<?php echo e(old('act_number', $nextActNumber)); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Город</label>
                    <input type="text" name="city" class="form-control" value="<?php echo e($passport->city ?? ''); ?>" required>
                </div>
            </div>

            <div class="mb-3">
                <label class="form-label">Дата составления</label>
                <input type="date" name="act_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="object_name" class="form-control"
                       value="<?php echo e(trim(($passport->object_name ?? '') .
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="contractor_representative" class="form-control"
                           value="<?php echo e($passport->contractor_responsible ? $passport->contractor_responsible . ', ' . $passport->contractor : ''); ?>" required>
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="tech_supervisor_representative" class="form-control"
                           value="<?php echo e($passport->tech_supervisor_responsible ? $passport->tech_supervisor_responsible . ', ' . $passport->tech_supervisor : ''); ?>" required>
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="author_supervisor_representative" class="form-control"
                           value="<?php echo e($passport->author_supervisor_responsible ? $passport->author_supervisor_responsible . ', ' . $passport->author_supervisor : ''); ?>">
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="work_executor" class="form-control" value="<?php echo e($passport->contractor ?? ''); ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="psd_info" class="form-control" rows="2" required><?php echo e($passport->project_developer ?? ''); ?><?php echo e($passport->psd_number ? ', ПСД №' . $passport->psd_number : ''); ?></textarea>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="contractor_sign_name" class="form-control" value="<?php echo e($passport->contractor_responsible ?? ''); ?>" required>
                    <label class="form-label mt-2">Подпись</label>
                    <input type="text" name="contractor_sign" class="form-control" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Представитель технадзора заказчика (ФИО)</label>
                    <input type="text" name="tech_supervisor_sign_name" class="form-control" value="<?php echo e($passport->tech_supervisor_responsible ?? ''); ?>" required>
                    <label class="form-label mt-2">Подпись</label>
                    <input type="text" name="tech_supervisor_sign" class="form-control" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Представитель авторского надзора (ФИО)</label>
                    <input type="text" name="author_supervisor_sign_name" class="form-control" value="<?php echo e($passport->author_supervisor_responsible ?? ''); ?>">
                    <label class="form-label mt-2">Подпись</label>
                    <input type="text" name="author_supervisor_sign" class="form-control">
                </div>
            </div>
            <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/ispolka/resources/views/acts/create.blade.php ENDPATH**/ ?>