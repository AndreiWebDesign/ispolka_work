...
// node_modules/ncalayer-js-client/ncalayer-client.js
var require_ncalayer_client = __commonJS({
  "node_modules/ncalayer-js-client/ncalayer-client.js"(exports) {
    ((exports2, WebSocket2, window2) => {
      ...
      class NCALayerClient {
        ...
        async connect() {
          ...
          this.wsConnection = new WebSocket2(this.url);
         ...
         * @throws NCALayerError
         */
        async basicsSign(allowedStorages, format, data, signingParams, signerParams, locale, forceSingleSignature = false) {
          const request = {
      ...
      exports2.NCALayerClient = NCALayerClient;
    })(
      typeof exports === "undefined" ? exports : exports,
      typeof WebSocket === "undefined" ? require_ws() : WebSocket,
      typeof window === "undefined" ? { btoa(x) {
        return x;
      } } : window
...
export default require_ncalayer_client();
//# sourceMappingURL=ncalayer-js-client.js.map
